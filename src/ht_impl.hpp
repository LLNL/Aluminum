...
class HTBackend {
 ...
 public:
  using allreduce_algo_type = HTCollectiveAlgorithm;
  ...
  using comm_type = internal::ht::HTCommunicator;
  using req_type = std::shared_ptr<internal::ht::HTRequest>;
  ...
  static std::string Name() { return "HTBackend"; }
 ...
 private:
  ...
  static void setup_completion_event(
    ...
    req = std::make_shared<internal::ht::HTRequest>(event, comm.get_stream());
  }
