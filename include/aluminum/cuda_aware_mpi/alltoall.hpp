...
/** Progress engine state for CUDA-aware MPI alltoall. */
template <typename T>
class AlltoallState : public CUDAAwareMPIState {
 public:
  AlltoallState(const T* sendbuf_, T* recvbuf_, size_t count_,
  ...
  std::string get_name() const override { return "CUDAAwareAlltoall"; }
 ...
 protected:
   void start_mpi_op() override {
     MPI_Ialltoall(mpi::buf_or_inplace(sendbuf), count, mpi::TypeMap<T>(),
