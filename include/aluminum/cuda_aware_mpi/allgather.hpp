...
/** Progress engine state for CUDA-aware MPI allgather. */
template <typename T>
class AllgatherState : public CUDAAwareMPIState {
 public:
  AllgatherState(const T* sendbuf_, T* recvbuf_, size_t count_,
 ...
 protected:
  void start_mpi_op() override {
    MPI_Iallgather(mpi::buf_or_inplace(sendbuf), count, mpi::TypeMap<T>(),
