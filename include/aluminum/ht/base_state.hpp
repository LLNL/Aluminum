...
public:
  HostTransferCollectiveSignalAtEndState(AlGpuStream_t stream_) :
...
class HostTransferCollectiveSignalRootEarlyState : public HostTransferCollectiveState {
 public:
  HostTransferCollectiveSignalRootEarlyState(bool is_root_, AlGpuStream_t stream_) :
...
class HostTransferCollectiveSignalNonRootEarlyState : public HostTransferCollectiveState {
 public:
  HostTransferCollectiveSignalNonRootEarlyState(bool is_root_, AlGpuStream_t stream_) :
    HostTransferCollectiveState(stream_), is_root(is_root_) {}
